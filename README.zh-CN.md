...
点开关条上的 ⚙ 选服务商并填 Key，两个站点分别设置。填入后「精选娱乐」这类细分判断明显更准。

| 服务商 | 模型 | 准确率 | 每千条 | 申请 |
|---|---|---|---|---|
| **阿里百炼** | qwen-flash | **0.898** | ¥0.017 | 支付宝登录，新用户送 100 万 token |
| 智谱 | glm-4-flash-250414 | 0.855 | **免费** | 手机号注册，免实名 |
| 硅基流动 | Qwen3-8B | 0.858 | **免费** | 需实名认证 |
| DeepSeek | deepseek-v4-flash | 待测 | ¥0.10 | 需充值 |

准确率为 400 条冻结评测集上的实测值，评测集从未参与训练，方法与完整数据见 [`research/LOG.md`](research/LOG.md) 的 E27。两个免费模型比 qwen-flash 少找出约四分之一的专业内容，其余判断相当。
